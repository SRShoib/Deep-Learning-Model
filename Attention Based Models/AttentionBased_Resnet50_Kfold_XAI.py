...
# Paths
dataset_path = r"D:\Research\Topics\Propagranate\Pomegranate_Diseases_Dataset"  # Path to your dataset
...
k_folds = 2  # Number of folds for K-Fold Cross-Validation
num_epochs = 50

# model save path
model_save_path = r"D:\Research\Topics\Propagranate\model\Attention_based\attention_Kfold2_updated.pth"
